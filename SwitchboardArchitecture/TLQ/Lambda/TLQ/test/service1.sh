...
json={"\"bucketname\"":"\"test.bucket.562f21.abc\"","\"filename\"":"\"Records.csv\"","\"servicename\"":"\"service1\""}
#json={"\"bucketname\"":"\"test.bucket.562f21.abc\"","\"filename\"":"\"Transformed_Record_Data.csv\""}
